...
|---|---|---|---|---|---|---|---|---|
| test_only | 51.5 | 37.3 | -14.2 | 0.725 | 0.169 | 0.289 | 0.344 | 0.249 |
| val_only | 29.8 | 26.3 | -3.4 | 0.885 | 0.149 | 0.259 | 0.276 | 0.244 |
| train_only | 131.7 | 87.0 | -44.7 | 0.66 | 0.103 | 0.187 | 0.235 | 0.155 |
| canonical_all | 213.0 | 150.6 | -62.3 | 0.707 | 0.125 | 0.223 | 0.269 | 0.190 |
| full_region | 237.4 | 165.7 | -71.7 | 0.698 | 0.132 | 0.233 | 0.284 | 0.198 |

**Headline (held-out test region):** predicted **37.3 ha** vs Hansen GFC **51.5 ha** (0.72x; -14.2 ha), pixel IoU 0.169.
